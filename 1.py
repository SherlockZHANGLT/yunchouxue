...
xinlist_train=np.load('xinlist_train.npy')  #   20*8初始车辆分布
...
for m in range(20): 
    ...
    #运载数小于需求量
    m.addConstrs((A0[i] <= dlist[i//8][i%8][1] for i in range(64)), 'c1')
    m.addConstrs((A1[i] <= dlist[i//8][i%8][2] for i in range(64)), 'c2')
    m.addConstrs((A2[i] <= dlist[i//8][i%8][3] for i in range(64)), 'c3')
    m.addConstrs((A3[i] <= dlist[i//8][i%8][4] for i in range(64)), 'c4')
    m.addConstrs((A4[i] <= dlist[i//8][i%8][5] for i in range(64)), 'c5')
    m.addConstrs((A5[i] <= dlist[i//8][i%8][6] for i in range(64)), 'c6')
